...
import ewasko.individual.Individual_MOTS;
import ewasko.infoToRun.DataFromFile;

import java.util.ArrayList;
import java.util.Random;

public class MultiObjectiveTabuSearch implements IMetaheuristics {
    ...
    MultiObjectiveTabuSearch(int numberOfSolutions, int numberOfGeners, int neighbourhoodSize, int tabuSize) {
        solutions = new ArrayList<>();
        this.numberOfSolutions = numberOfSolutions;
        this.numberOfGeners = numberOfGeners;
        this.neighbourhoodSize = neighbourhoodSize;
        MultiObjectiveTabuSearch.tabuSize = tabuSize;
...
//        for (individual.Individual_MOTS i : solutions) {
